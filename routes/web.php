...
/* PainelAdmin */
Route::get('paineladmin/paineladmin', 'PainelAdminController@getPainelAdmin')->name('paineladmin');
Route::get('paineladmin/gerenciar/midia', 'PainelAdminController@getMidia')->name('midia');